...
class EntityManager:
    ...
    def create_entity(self) -> int:
        """Tworzy nowy, pusty byt i zwraca jego ID."""
    ...
    def get_entities_with(self, *component_types: Type) -> list[int]:
        """Znajduje wszystkie byty, które posiadają podane typy komponentów."""
        matching_entities = []
...
class MovementSystem:
    def update(self, manager: EntityManager):
        """Szuka bytów z Pozycją i Prędkością i aktualizuje ich pozycję."""
...
class RenderSystem:
    def update(self, manager: EntityManager):
        """Szuka bytów z Pozycją i Renderem i synchronizuje je z PyQt."""
